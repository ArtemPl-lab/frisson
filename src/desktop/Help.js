                        ...
                        <div className="row">
                            <div className="col col-md-5">
                                <div className="title">
                                    ...
                                    <p>Если у вас возникли вопросы об условиях сотрудничества, вы заметили сбои в работе приложения, просто хотите поделиться советом или респектом  — смело пишите на  <a href="mailto:contact@frisson.com">info@frissonapp.com</a>.</p>
                                </div>
                            </div>
